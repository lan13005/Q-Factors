...
ClassImp(bivariateGaus); 
 ...
 { 
   ...
   return 1/(6.283185*sx*sy*sqrt(1-pow(r,2)))*exp(-1/(2*(1-pow(r,2)))*(pow(((x-px)/sx),2)-2*r*((x-px)/sx)*((y-py)/sy)+pow(((y-py)/sy),2))) ; 
   //return 1/(6.283185*sx*sy*sqrt(1-pow(r,2)))*exp(-1/(2*(1-pow(r,2)))*(pow(((x-px)/sx),2)-2*r*((x-px)/sx)*((y-py)/py)+pow(((y-py)/py),2))) ; 
 } 
