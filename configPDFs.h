...
class fitManager
{
	...
	fitManager(string iProcess){ 
            ...
            sx = new RooRealVar{("sx"+iProcess).c_str(),"sx",initSigmaX*1.1,initSigmaX*0.5,initSigmaX*1.5};
            py = new RooRealVar{("py"+iProcess).c_str(),"py",initMassY};
            sy = new RooRealVar{("sy"+iProcess).c_str(),"sy",initSigmaY*1.1,initSigmaY*0.5,initSigmaY*1.5};
